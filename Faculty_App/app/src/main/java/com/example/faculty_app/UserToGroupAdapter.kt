...
import com.example.faculty_app.ui.user_to_group.EditUserToGroupActivity

class UserToGroupAdapter(private val viewModel: UserToGroupViewModel) : ListAdapter<UserToGroup, UserToGroupAdapter.UserToGroupViewHolder>(UserToGroupDiffCallback()) {
